...
Docked to length (with a few millimeters to spare for cutting off later), I then cleaned up the sawn surfaces (a bit; I’m not fussy, and sometimes like to see some saw marks). I usually work with [Tas. Oak](https://en.wikipedia.org/wiki/Tasmanian_oak "'Tasmanian Oak' at Wikipedia"), and am always surprised at the soft squishiness of pine, and the speed with which it can be worked (or butchered, as one might say in this case).
...
_The album for all these photos is at [photos.samwilson.id.au/index/category/222](http://photos.samwilson.id.au/index/category/222)._